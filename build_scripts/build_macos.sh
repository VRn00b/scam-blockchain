...
if [ "$NOTARIZE" ]; then
  electron-osx-sign Scam-darwin-x64/Scam.app --platform=darwin \
...
mv Scam-darwin-x64 ../build_scripts/dist/
cd ../build_scripts || exit

DMG_NAME="Scam-$SCAM_INSTALLER_VERSION.dmg"
echo "Create $DMG_NAME"
mkdir final_installer
electron-installer-dmg dist/Scam-darwin-x64/Scam.app Scam-$SCAM_INSTALLER_VERSION \
