...
describe('units', () => {
  describe('#getUnit', () => {
    it('gets unit of scam', () => {
      const result = units.getUnit('scam');
    ...
    it('gets unit of scam using alias', () => {
  ...
  describe('#getDisplay', () => {
    it('gets display of scam', () => {
      const result = units.getDisplay('scam');
  ...
  describe('#setUnit', () => {
    ...
    it('modifies an existing unit', () => {
      units.setUnit('scam', 9);

      const result = units.getUnit('scam');

      expect(result).toEqual(9);

      units.setUnit('scam', 1);
    });
  });
  describe('#setDisplay', () => {
