...
import icon from '../../assets/img/scam_circle.svg';
...
const url = 'https://scamnetwork.net';
  ...
  return (
    <html>
      ...
      <body>
        ...
        <Spacer />
        <div className="copyright">Copyright (c) 2021 Scam Network</div>
        <Spacer />
        <VersionsTable>
          {versions?.electron && (
            <tr>
        ...
        <BugReport
          href="https://github.com/vrn00b/scam-blockchain/issues"
          target="_blank"
        >
          Report an issue
        </BugReport>
