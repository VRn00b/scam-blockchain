...
import { CardHero, Flex, Link } from '@scam/core';
import { PlotHero as PlotHeroIcon } from '@scam/icons';
      ...
      <Grid xs={12} md={6} lg={5} item>
        <CardHero>
          ...
          <Typography variant="body1">
            <Trans>
              {
                'Plots are allocated space on your hard drive used to farm and earn Scam. '
              }
              <Link
                target="_blank"
                href="https://github.com/vrn00b/scam-blockchain/wiki/Network-Architecture"
              >
                Learn more
              </Link>
            </Trans>
