...
import { /* mojo_to_scam_string, */ scam_to_mojo } from '../../../util/scam';
  ...
  return (
    <Grid item xs={12}>
      <Box display="flex">
        ...
        <Box>
          <Typography variant="subtitle1">
            {mojo_to_scam_string(props.balance)} {currencyCode}
          </Typography>
        </Box>
      </Box>
    </Grid>
  ...
  return (
    <Card title={<Trans>Balance</Trans>}>
      <BalanceCardSubSection
        ...
        tooltip={
          <Trans>
            This is the total amount of scam in the blockchain at the current
      ...
      <BalanceCardSubSection
        ...
        tooltip={
          <Trans>
            This is the amount of Scam that you can currently use to make
            transactions. It does not include pending farming rewards, pending
            incoming transactions, and Scam that you have just spent but is not
...
function SendCard(props: SendCardProps) {
  ...
  function handleSubmit(data: SendTransactionData) {
    ...
    if (address.includes('colour')) {
      dispatch(
        openDialog(
          <AlertDialog>
            <Trans>
              Error: Cannot send scam to coloured address. Please enter a scam
              address.
            </Trans>
          </AlertDialog>,
        ),
    ...
    if (address.slice(0, 12) === 'scam_addr://') {
    ...
    const amountValue = Number.parseFloat(scam_to_mojo(amount));
    const feeValue = Number.parseFloat(scam_to_mojo(fee));
