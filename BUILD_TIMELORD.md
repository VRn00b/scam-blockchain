...
required to run a [Timelord](https://github.com/vrn00b/scam-blockchain/wiki/Timelords).
...
[install-timelord.sh](https://github.com/vrn00b/scam-blockchain/blob/main/install-timelord.sh)
