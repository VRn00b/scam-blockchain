...
from scam.pools.pool_config import PoolWalletConfig
from scam.util.config import load_config, save_config, create_default_scam_config
...
def test_pool_config():
    ...
    create_default_scam_config(test_root, ["config.yaml"])
