...
from scam.full_node.mempool import Mempool
from scam.full_node.mempool_check_conditions import mempool_check_conditions_dict, get_name_puzzle_conditions
...
from scam.util.clvm import int_from_bytes
from scam.util.condition_tools import (
...
class MempoolManager:
    def __init__(self, coin_store: CoinStore, consensus_constants: ConsensusConstants):
        ...
        # transactions. This prevents spam. This is equivalent to 0.055 SCM per block, or about 0.00005 SCM for two
        # spends.
