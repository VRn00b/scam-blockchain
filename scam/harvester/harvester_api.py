...
from scam.consensus.pot_iterations import calculate_iterations_quality, calculate_sp_interval_iters
from scam.harvester.harvester import Harvester
from scam.plotting.plot_tools import PlotInfo, parse_plot_info
from scam.protocols import harvester_protocol
from scam.protocols.farmer_protocol import FarmingInfo
from scam.protocols.harvester_protocol import Plot
...
from scam.util.api_decorators import api_request, peer_required
...
class HarvesterAPI:
    ...
    async def new_signage_point_harvester(
        self, new_challenge: harvester_protocol.NewSignagePointHarvester, peer: WSScamConnection
    ):
        """
