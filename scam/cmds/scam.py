...
from scam.cmds.configure import configure_cmd
from scam.cmds.farm import farm_cmd
from scam.cmds.init import init_cmd
from scam.cmds.keys import keys_cmd
from scam.cmds.netspace import netspace_cmd
from scam.cmds.plots import plots_cmd
from scam.cmds.show import show_cmd
from scam.cmds.start import start_cmd
from scam.cmds.stop import stop_cmd
from scam.cmds.wallet import wallet_cmd
from scam.cmds.plotnft import plotnft_cmd
...
@click.group(
    help=f"\n  Manage scam blockchain infrastructure ({__version__})\n",
    epilog="Try 'scam start node', 'scam netspace -d 192', or 'scam show -s'",
...
@cli.command("version", short_help="Show scam version")
def version_cmd() -> None:
    print(__version__)


@cli.command("run_daemon", short_help="Runs scam daemon")
@click.pass_context
def run_daemon_cmd(ctx: click.Context) -> None:
    from scam.daemon.server import async_run_daemon
    import asyncio
