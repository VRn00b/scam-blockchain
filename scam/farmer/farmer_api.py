...
from scam.farmer.farmer import Farmer
from scam.protocols import farmer_protocol, harvester_protocol
from scam.protocols.harvester_protocol import PoolDifficulty
...
class FarmerAPI:
    ...
    async def new_proof_of_space(
        self, new_proof_of_space: harvester_protocol.NewProofOfSpace, peer: ws.WSScamConnection
    ):
        """
