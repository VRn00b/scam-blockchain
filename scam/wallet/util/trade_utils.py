...
from scam.util.condition_tools import conditions_dict_for_solution
    ...
    try:
        ...
        for coinsol in trade_offer.coin_solutions:
            ...
            if r:
                ...
                if "scam" in cc_discrepancies:
                    cc_discrepancies["scam"] = cc_discrepancies["scam"] + diff
                else:
                    cc_discrepancies["scam"] = diff
