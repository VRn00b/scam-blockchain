...
from scam.util.ints import uint32, uint16
...
async def main() -> None:
    ...
    try:
        ...
        address1 = "scm1n2twe0u0udegk2ug037hkaw50vhdm8ff9ghzfrutmf70qcmd3udqxqys52"  # Key 1
        address2 = "scm1n2twe0u0udegk2ug037hkaw50vhdm8ff9ghzfrutmf70qcmd3udqxqys52"  # Key 2
        ...
        print(f"Ph1: {ph1.hex()}")
        print(f"Ph2: {ph2.hex()}")
        assert ph1.hex() == "9a96ecbf8fe3728b2b887c7d7b75d47b2edd9d292a2e248f8bda7cf0636d8f1a"
        assert ph2.hex() == "9a96ecbf8fe3728b2b887c7d7b75d47b2edd9d292a2e248f8bda7cf0636d8f1a"
