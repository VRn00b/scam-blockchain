...
from scam.consensus.cost_calculator import calculate_cost_of_program, NPCResult
...
from scam.protocols.wallet_protocol import PuzzleSolutionResponse
...
from scam.util.condition_tools import conditions_dict_for_solution, pkm_pairs_for_conditions_dict
...
from scam.wallet.cc_wallet.cc_info import CCInfo
from scam.wallet.cc_wallet.cc_utils import (
    CC_MOD,
    SpendableCC,
...
from scam.wallet.puzzles.genesis_by_coin_id_with_0 import (
