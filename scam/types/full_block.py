...
from scam.types.blockchain_format.foliage import Foliage, FoliageTransactionBlock, TransactionsInfo
...
from scam.types.blockchain_format.vdf import VDFProof
